...
{
    /// <summary>
    /// An abstract class for screenshot filename strategies. This class generates a file path from a directory path and
    /// a file name prefix and an unique identifier.
    /// </summary>
    public abstract class AbstractPrefixAndUniqueIDStrategy : IScreenshotFileNameStrategy
    {
        ...
        /// If no filename or empty filename specified, a file name returned from
        /// <c cref="GetDefaultFilenamePrefix">GetDefaultFilenamePrefix</c> will be used instead
        /// </summary>
        /// <returns>A filename prefix</returns>
